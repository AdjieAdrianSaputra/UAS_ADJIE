...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="{{ url('/admin') }}"><strong>Alat</strong> Piknik BNA</a>
  ...
  <!-- Barang -->
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          @foreach($pesanan as $nomor => $result)
          <tr>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2024 -  Designed by Adjieadrian</p>
          </div>
          </div>
